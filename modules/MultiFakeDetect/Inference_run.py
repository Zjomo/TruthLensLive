    ...
    def main(self):
        ...
        # 推理
            ...
            if self.dataset=='fakesv':
                ...
                save_predict_result_path='./predict_result/FakeTT/'
            elif self.dataset=='fakejm':
                test_file='./data/FakeJM/data-split/vid_time3_test.txt'
                save_predict_result_path='./predict_result/FakeJM/'
            dataloader = self.get_dataloader(test_file)
            inferncer = Inferencer(model=self.model,
                                   device=self.device,
                                   model_name='FakingRecipe',
