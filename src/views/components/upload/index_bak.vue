...
<template>
  ...
  <el-card shadow="never">
    ...
    <!--上传组件，drag-可拖拽；multiple-多选；list-type-图片列表；accept-文件类型；action-上传接口；limit-最大上传数；headers-请求头；on-exceed-超出最大上传数时触发；before-upload-上传文件前校验-->
    <el-upload
